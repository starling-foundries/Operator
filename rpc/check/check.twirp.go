...
/*
Package twirp_check is a generated twirp stub package.
...
type Check interface {
	...
	Send(context.Context, *CheckTransaction) (*QueueID, error)
	...
	LastTransaction(context.Context, *Empty) (*StatusResp, error)
}
...
func NewCheckProtobufClient(addr string, client HTTPClient) Check {
	prefix := urlBase(addr) + CheckPathPrefix
	urls := [3]string{
		prefix + "Send",
		prefix + "Status",
		prefix + "LastTransaction",
	}
...
func (c *checkProtobufClient) Send(ctx context.Context, in *CheckTransaction) (*QueueID, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.check")
...
func (c *checkProtobufClient) Status(ctx context.Context, in *QueueID) (*StatusResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.check")
	ctx = ctxsetters.WithServiceName(ctx, "Check")
...
func (c *checkProtobufClient) LastTransaction(ctx context.Context, in *Empty) (*StatusResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.check")
	ctx = ctxsetters.WithServiceName(ctx, "Check")
	ctx = ctxsetters.WithMethodName(ctx, "LastTransaction")
	out := new(StatusResp)
...
func NewCheckJSONClient(addr string, client HTTPClient) Check {
	prefix := urlBase(addr) + CheckPathPrefix
	urls := [3]string{
		prefix + "Send",
		prefix + "Status",
...
func (c *checkJSONClient) Send(ctx context.Context, in *CheckTransaction) (*QueueID, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.check")
	ctx = ctxsetters.WithServiceName(ctx, "Check")
	ctx = ctxsetters.WithMethodName(ctx, "Send")
	out := new(QueueID)
...
func (c *checkJSONClient) Status(ctx context.Context, in *QueueID) (*StatusResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.check")
	ctx = ctxsetters.WithServiceName(ctx, "Check")
	ctx = ctxsetters.WithMethodName(ctx, "Status")
	out := new(StatusResp)
...
func (c *checkJSONClient) LastTransaction(ctx context.Context, in *Empty) (*StatusResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.check")
	ctx = ctxsetters.WithServiceName(ctx, "Check")
	ctx = ctxsetters.WithMethodName(ctx, "LastTransaction")
	out := new(StatusResp)
...
func NewCheckServer(svc Check, hooks *twirp.ServerHooks) TwirpServer {
	return &checkServer{
		Check: svc,
		hooks: hooks,
	}
...
// CheckPathPrefix is used for all URL paths on a twirp Check server.
// Requests are always: POST CheckPathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const CheckPathPrefix = "/twirp/twirp.check.Check/"
...
func (s *checkServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirp.check.Check/Send":
		s.serveSend(ctx, resp, req)
		return
	case "/twirp/twirp.check.Check/Status":
		s.serveStatus(ctx, resp, req)
		return
	case "/twirp/twirp.check.Check/LastTransaction":
		s.serveLastTransaction(ctx, resp, req)
		return
	default:
...
func (s *checkServer) serveSend(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *checkServer) serveSendJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Send")
	...
	func() {
		...
		respContent, err = s.Check.Send(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *QueueID and nil error while calling Send. nil responses are not supported"))
		return
	}
...
func (s *checkServer) serveSendProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Send")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *checkServer) serveStatus(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *checkServer) serveStatusJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Status")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.Check.Status(ctx, reqContent)
	}()
...
func (s *checkServer) serveStatusProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Status")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *checkServer) serveLastTransaction(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveLastTransactionJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveLastTransactionProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *checkServer) serveLastTransactionJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "LastTransaction")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.Check.LastTransaction(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *StatusResp and nil error while calling LastTransaction. nil responses are not supported"))
		return
	}
...
func (s *checkServer) serveLastTransactionProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "LastTransaction")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
